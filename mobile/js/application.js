...
function viewFullWebsite() {
   ...
   $.cookie('layoutMode', 2, { expires: 1, path: '/' });
    if ($.cookie('layoutMode') == 2) {
        console.log('clicking on mobile website to go to main website');
        console.log($.cookie('layoutMode') + " is the current cookie");
        window.location = "http://pacis2015.comp.nus.edu.sg/index.html";
    }

	
	window.location.href = "http://pacis2015.comp.nus.edu.sg/index.html?viewFullWebsite";
}
...
$(document).ready(function() {
    console.log($.cookie('layoutMode') + " is the current cookie. In mobile site now.");
